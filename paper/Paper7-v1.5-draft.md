...
date: "April 2026 | Version 1.5 | CC BY 4.0"
---
...
April 2026 | Version 1.5 | CC BY 4.0
...
**Depth effect (depth-0 → depth-6):** +0.573 bits — BPT *increases* with grammar depth in this experiment, the opposite of the pretrained-GPT-2 result in §3.5. This is the predicted behavior for a from-scratch model on a finite training budget: it can learn shallow grammar to convergence (depth 0 BPT = 3.22, near source entropy of ~3.9 bits/character) but cannot fully exploit recursive nesting at depth 6 within 5 epochs of 300K words. The 6.5-bit gap to natural language remains.
