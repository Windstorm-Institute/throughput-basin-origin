...
**Data Availability Statement:** All experiment code and data are publicly available at https://github.com/Windstorm-Labs/throughput-basin-origin (accessed 12 April 2026). The full adversarial review is available in the companion repository.

**Acknowledgments:** This paper was developed through adversarial review by six frontier AI models. All experiments were performed with the assistance of Claude (Anthropic), an AI research tool. GPU computations (14.5 hours total) were executed on an NVIDIA RTX 5090.
...
7. Shannon, C.E. A Mathematical Theory of Communication. *Bell Syst. Tech. J.* **1948**, *27*, 379--423. DOI: 10.1002/j.1538-7305.1948.tb01338.x
...
9. Whitmer, G.L., III. Throughput Basin Origin: Experiment Code and Data. *GitHub* **2026**. Available online: https://github.com/Windstorm-Labs/throughput-basin-origin (accessed 12 April 2026).
...
*This paper is Paper 7 of The Windstorm Series, completing the core causal chain from physics to AI. The full series: Paper 1: The Fons Constraint [1], Paper 2: The Receiver-Limited Floor [2], Paper 3: The Throughput Basin [3], Paper 4: The Serial Decoding Basin [4], Paper 5: The Dissipative Decoder [5], Paper 6: The Inherited Constraint [6], Paper 7: The Throughput Basin Origin (this paper), Paper 8: The Vision Basin (DOI: 10.5281/zenodo.19672827), and Paper 9: The Hardware Basin (DOI: 10.5281/zenodo.19672921).*
